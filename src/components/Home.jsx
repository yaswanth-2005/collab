      ...
      <React.Fragment>
        <div className="container pt-5">
          ...
          <div className="text-center mt-5">
            <h2
              style={this.getStyle.fontCreator}
...
function SectionHello(props) {
  return (
    <React.Fragment>
      <h3 style={props.getStyle.fontHello}>Create Your Own Terms..,</h3>
      <p style={props.getStyle.fontParagraph} className="mt-4">
        ...
        biggest fans and generate predictable, recurring revenue from your
        creative work.
      </p>
      <button
        className="btn btn-danger mt-2"
        style={props.getStyle.helloButton}
      >
        Get Started
      </button>
    </React.Fragment>
    ...
    <div className="card">
      ...
      <div className="card-footer" style={props.style.cardSmoke}>
        <div className="card-text p-3">
          ...
          <strong>Issa Belle</strong>, Video Creator
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ backgroundColor: "whitesmoke" }}>
      <div className="container mt-3 p-5">
        <div className="text-center mt-5 mb-5">
          ...
          <p>
            elevatr is a creator-founded company, helping creators build
            membership <br />
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-4 p-4 text-center">
            ...
            <div className="text-center">
              ...
              <p>
                Connect with your biggest fans directly, free from the ads and
          ...
          <div className="col-md-4 p-4 text-center">
            ...
            <div className="text-center">
              ...
              <p>
                Give your fans what they want: a peek behind the scenes, extras
                they can’t get elsewhere, and the pride of fueling what you do
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-8 mt-4">
              <p>
                ...
                fans — the ones that choose to go a level deeper than just
                following you on social media. They become paying patrons in
                exchange for exclusive benefits you offer.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="row mt-4 mb-4">
        <div className="col-md-6 text-center">
          <img
            ...
            style={{ maxWidth: "100%" }}
          />
          {props.image2 ? <img src={props.image2} alt="second_image" /> : null}
        </div>
        <div className="col-md-6">
          <div style={stepStyle.stepText}>{props.children}</div>
        </div>
      </div>
    );
  }
    ...
    <React.Fragment>
      <LeftStep image={Step1}>
        <React.Fragment>
          <p>STEP 1</p>
          <h2>
            <b>Tell your fans you're launching on elevatr.</b>
          </h2>
          <p>
      ...
      <RightStep image={Step2}>
        <p>STEP 2</p>
        <h2>
          <b>Set up your page and membership tiers, and launch!</b>
        </h2>
        <p>
          Each tier has different benefits for different levels of engagement
          with you. When you’re ready, launch your membership and tell your
          fans.
        </p>
      </RightStep>
      <LeftStep image={Step3} image2={Step3Bottom}>
        <React.Fragment>
          <p>STEP 3</p>
          <h2>
            <b>Develop relationships by taking them along on the journey.</b>
          </h2>
          <p>
