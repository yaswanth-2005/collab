      ...
      <div className="row p-5">
        ...
        <div className="col-md-3">
          <List>
            ...
            <li>
              <Linked href="/">Create on elevatr</Linked>
            </li>
            <li>
              <Linked href="/">Brand</Linked>
            </li>
            <li>
              <Linked href="/">Press</Linked>
            </li>
            <li>
              <Linked href="/">Partners</Linked>
            </li>
            <li>
              <Linked href="/">Sitemap</Linked>
            </li>
          </List>
        </div>
        <div className="col-md-3">
          <List>
            <li>
              <Linked href="/">Help Center & FAQs</Linked>
            </li>
            <li>
              <Linked href="/">Developers</Linked>
            </li>
            <li>
              <Linked href="/">App Directory</Linked>
            </li>
            <li>
              <Linked href="/">Blog</Linked>
            </li>
            <li>
              <Linked href="/">elevatr U | Creator Coaching</Linked>
            </li>
            <li>
              <Linked href="/">Community Guidelines</Linked>
            </li>
            <li>
              <Linked href="/">Terms of Use</Linked>
            </li>
            <li>
              <Linked href="/">Privacy Policy</Linked>
            </li>
          </List>
        </div>
        <div className="col-md-3">
          <List>
            ...
            <li className="mt-3 mb-3">
              <svg width="151" height="45" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient
                    x1="90.769%"
                    y1="4.84%"
                  ...
                  >
                    ...
                    <stop stopColor="#00A1FF" offset=".7%"></stop>
                    <stop stopColor="#00BEFF" offset="26%"></stop>
                    <stop stopColor="#00D2FF" offset="51.2%"></stop>
                  ...
                  >
                    ...
                    <stop stopColor="#FFBD00" offset="40.9%"></stop>
                    <stop stopColor="orange" offset="77.5%"></stop>
            ...
            <li>
              <svg width="151" height="45" xmlns="http://www.w3.org/2000/svg">
                ...
                <g fillRule="nonzero" fill="none">
                  <path
                    d="M149.772 39.458a4.314 4.314 0 0 1-1.256 3.044 4.275 4.275 0 0 1-3.033 1.26H5.113c-2.369.002-4.291-1.925-4.295-4.304V5.135C.822 2.755 2.743.826 5.113.825h140.369a4.28 4.28 0 0 1 3.033 1.263 4.318 4.318 0 0 1 1.256 3.047l.001 34.323z"
                    fill="#FFF"
                  ></path>
                  <path
                    d="M145.709 45H5.292C2.373 45 .006 42.623 0 39.687V5.318C.004 2.382 2.372.002 5.292 0h140.416c2.92.004 5.286 2.382 5.292 5.318v34.37c.002 2.93-2.376 5.312-5.291 5.312z"
                    fill="#A6A6A6"
                  ></path>
                  <path
                    d="M149.772 39.458a4.314 4.314 0 0 1-1.256 3.044 4.275 4.275 0 0 1-3.033 1.26H5.113c-2.369.002-4.291-1.925-4.295-4.304V5.135C.822 2.755 2.743.826 5.113.825h140.369a4.28 4.28 0 0 1 3.033 1.263 4.318 4.318 0 0 1 1.256 3.047l.001 34.323z"
